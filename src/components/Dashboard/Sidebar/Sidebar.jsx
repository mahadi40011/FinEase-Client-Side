...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* 2. Sidebar Container */}
      <div
        className={`z-20 fixed inset-y-0 left-0 flex flex-col justify-between bg-white h-screen border-r border-gray-100 transition-all duration-300 ease-in-out md:w-64 w-full transform ${
      ...
      >
        <div className="flex flex-col h-full overflow-y-auto custom-scrollbar">
          ...
          <div className="flex-1 px-4">
            ...
            {/* Role-Based Menus */}
            <nav className="space-y-1">{user && <UserMenu />}</nav>
          </div>
